...
function extendClass(superClass, members) {
	...
	// ensure a constructor for the subclass, forwarding all arguments to the super-constructor if it do not exist
...
// Returns moment's internal locale data. If do not exist, returns English.
