...
$proCatTop =<<<IGWEZE
						...
						<div class="col-md-4" >
						<section class="panel" style="border: 1px solid #ccc !important;border-radius: 15px; -webkit-border-radius: 15px">
						...
						<div class="add-to-cart"> 
							...
							<select class="p-qty col-lg-4 pro-select">
...
IGWEZE;
				...
				if($_REQUEST['eProduct'] == true){ $stopLoader = " hidePageLoader();  /* hide page loader */ "; $lableBtn = "Update <span class='hide-res'>Cart<span>";}
							...
							<div class="panel-body" >
								<div class="col-md-6">
									...
									<div class="pro-img-list">
										...
										<a href="javascript:;">
											<img src="$fiPicture" alt="product picture" class="enlargePic" id="fi-$fiPicture">
										</a>
										<a href="javascript:;">
											<img src="$sePicture" alt="product picture" class="enlargePic" id="se-$sePicture">
										</a>
										<a href="javascript:;">
											<img src="$thPicture" alt="product picture" class="enlargePic" id="th-$thPicture">
										</a>
										<a href="javascript:;">
											<img src="$foPicture" alt="product picture" class="enlargePic" id="fo-$foPicture">
										</a>
										<a href="javascript:;">
											<img src="$fifPicture" alt="product picture" class="enlargePic" id="fif-$fifPicture">
										</a>
									</div>
								</div>
