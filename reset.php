	...
	<body class="lock-screen">  
		...
		<div class="container">
			...
			<div class="login-wrap login-wrap-reset"> 
				...
				<div class="login-footer" style=""> <b><span class="logo col-i-1">wizGrade</span></b> V1.3</div>	
...
<!-- form  -->  
			...
			<div class="login-wrap login-wrap-reset"> 
				...
				<div class="login-footer" style=""> <b><span class="logo col-i-2">wizGrade</span></b> V1.3</div>         
