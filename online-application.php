...
/*   
	...
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
		...
		define('fobrain', 'igweze');  /* defin55e a check for wrong access of file */ 
...
?>
		...
		<!-- page start--> 
			...
			<section class="panel col-lg-2"></section>
				...
				<div class="display-none"  id="wizCall"><span class="col-i-1">fobrain call</span></div>				
				...
				style="cursor:pointer; display:none; margin-bottom:5px;" /> </center>
					...
					<form enctype="multipart/form-data" class="form-horizontal frmsaveReg" id="wizardfrm" 
						...
						<div class="display-none" id="wizAns"><span class="col-i-2">fobrain ans</span></div>
