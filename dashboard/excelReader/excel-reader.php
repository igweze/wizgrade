 ...
 */
		...
		//977 $res = $this->_ole->read($sFileName);
		//988 $this->data = $this->_ole->getWorkBook(); 
		//split to explode
		
		//comment to remove all error  103
		//944 change function Spreadsheet_Excel_Reader($file='',$store_extended_info=true,$outputEncoding='') {
	    // to  public function __construct($file='',$store_extended_info=true,$outputEncoding='') {
