		 			...
		 			try {
							...
							$ebele_mark = "UPDATE $i_student_tb SET
								...
								if ($igweze_prep->execute()) {
										...
										$msg_s = "Student Profile with <span> $regNum </span>  Step 2 was Successfully Saved.";
                    ...
                    Thanks ";
		 			...
		 			try { 
							...
							if ($igweze_prep->execute()) {
								...
								$msg_s = "Student Profile with <span> $regNum </span> Step 3 was Successfully Saved.";
                    ...
                    Thanks ";
		 			...
		 			try {
							...
							if ($igweze_prep->execute()) {  /* if sucessfully */
								...
								$msg_s = "Student Profile with <span> $regNum</span> Sponsor Data was Successfully Saved.";
      			...
      			if ($regNum == "")  {
					...
					try {
							...
							if ($igweze_prep->execute()) {  /* if sucessfully */
									...
									$msg_s = "Student Profile with <span> $regNum </span> Class Infomation was Successfully Saved";
