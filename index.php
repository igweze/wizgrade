	...
	<body class="lock-screen">  
		...
		<div class="container">
			...
			<h2 class="login-form-heading">
				<?php echo $schoolNameTop; ?> <br /> School Portal  
			</h2>
			<div id="loginMsgBox" style="margin: 0% 10% 0% 10%;"></div>

			<div class="login-wrap"> 
				<div class="form-group">
					<label for="username" class="col-lg-2 col-sm-2 control-label hide-res">
				...
				<div class="form-group">
					<label for="password" class="col-lg-2 col-sm-2 control-label hide-res">
				...
				<div class="form-group">
					...
					<i class="fa fa-user-o login-icon"></i></label>
					<div class="col-lg-10">
				...
				<button class="btn btn-lg btn-login btn-block" id="loginBtn" type="submit" > <i class="fa fa-lock"></i> 
				Sign in</button> 
